---
title: Other layouts
description: Showing other layouts this template offers
permalink: /other-layouts/
layout: layouts/page
tags: website
eleventyNavigation:
  parent: website-agencies
  key: website-agencies-main
  order: 1
  title: Agencies
sidenav: false
...
Here are other layouts found in `_includes/layouts` that you can use for development of your website:

- `data.html`: Used to load data from the `_data/` folder
- `post.html`: This is used in blog posts
- `wide.html`: Used when you want to fill the width of the page. Typically reserved for home page
